...
const EditForRVMCreditSettings: React.FC<{ handleClose: () => void }> = ({ handleClose }) => {
    const {
        handleSubmit,
        control
    } = useForm<IFormValues>();
    ...
    return (
        ...
        >
            <Controller
                ...
                defaultValue={CREDIT_SETTING_MODAL_TYPE.RINGLESS_VOICE_MAIL.credit}
...
export default EditForRVMCreditSettings
